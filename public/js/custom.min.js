  ...
  var Blog = class {
    ...
    RIP() {
      ...
      const todayEvents = RIP_EVENTS.filter((event) => {
        ...
        return (eventYear === "*" || parseInt(eventYear) === today.year) && (eventMonth === "*" || parseInt(eventMonth) === today.month) && (eventDate === "*" || parseInt(eventDate) === today.date || today.date >= parseInt(eventDate) && now <= eventEndDate);
      });
